...
const homeworkLog = `03/22 08:54:24 INFO   :......rsvp_flow_stateMachine: state RESVED, event T1OUT
...
const data = fs.writeFileSync("./log.txt", homeworkLog, 'utf-8')
const readData = fs.readFileSync("./log.txt", 'utf-8')
